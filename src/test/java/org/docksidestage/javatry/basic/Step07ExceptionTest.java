...
public class Step07ExceptionTest extends PlainTestCase {
    ...
    public void test_exception_translation_improveChallenge() {
        ...
        // Caused by について下の問題を解くことで知ったので、
        // Caused by によってうまく連鎖されて表示されるようにエラーハンドリングを行おうと思います。
        //
        // そのクラスから投げられることが自然な Exception クラスを各クラスに実装して、
